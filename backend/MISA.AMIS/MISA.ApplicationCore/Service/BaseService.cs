                        ...
                        for (int i = 3; i <= rows; i++)
                        {
                            ...
                            for (int j = 0; j < listKey.Count(); j++)
                            {
                                ...
                                if (worksheet.Cells[i, j + 1].Value != null)
                                {
                                    ...
                                    //set department name
                                    if (key == Properties.Resources.DepartmentName)
                                    {
                                        departmentName = value;

                                        /*//set department id
                                        IEnumerable<Department> department = _departmentRepository.GetByDepartmentName(departmentName);

                                        if (department.Count() > 0)
                                        {
                                            generic.GetType().GetProperty(Properties.Resources.DepartmentId).SetValue(generic, department.FirstOrDefault().DepartmentId);
                                        }*/
